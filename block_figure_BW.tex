...
\begin{document}
    ...
    \begin{tikzpicture}[scale=0.5, every node/.style={scale=0.6}]
        ...
        \draw[pattern={horizontal lines}, pattern color=red!50, draw= none]  (0,2.5) -- (0,4.5) -- (2,4.5) -- (2,2.5) -- cycle;
        \fill [fill=red, draw=red, very thick, opacity = 0.2]     (0,2.5) -- (0,4.5) -- (2,4.5) -- (2,2.5) -- cycle;
